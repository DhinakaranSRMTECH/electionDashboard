function drawParliamentaryChart(selector, data, stc, btn_data, year, forLeg, forTot){
    var semiPie = (function() {
        ...
        jQuery.ajax({
            ...
            'url': data,
            'success': function(d) {
                if(data == "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result") {
...
// drawParliamentaryChart("#mn2022_parliamentseats", "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result", "mp", 'mn', '2022', "#mn_2022", "#mn2022Seat");
// drawParliamentaryChart("#pb2022_parliamentseats", "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result", "pu", 'pb', '2022', "#pb_2022", "#pb2022Seat");
// drawParliamentaryChart("#up2022_parliamentseats", "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result", "up", 'up', '2022', "#up_2022", "#up2022Seat");
// drawParliamentaryChart("#uk2022_parliamentseats", "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result", "uk", 'uk', '2022', "#uk_2022", "#uk2022Seat");
// drawParliamentaryChart("#ga2022_parliamentseats", "https://thefederal.com/api/scraper.php?m=election2022_result&t=partywise_result", "go", 'ga', '2022', "#ga_2022", "#ga2022Seat");